...
namespace Utils.Core.PlayerPrefsEditor
{
    public class ImageManager
    {
        ...
        public static Texture2D OsLinuxIcon
        {
            get
            {
                if (osLinuxIcon == null)
                {
                    osLinuxIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "os_linux_icon.png", typeof(Texture2D));
                }
                return osLinuxIcon;
            }
        }
        ...
        public static Texture2D OsWinIcon
        {
            get
            {
                if (osWinIcon == null)
                {
                    osWinIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "os_win_icon.png", typeof(Texture2D));
                }
                return osWinIcon;
            }
        }
        ...
        public static Texture2D OsMacIcon
        {
            get
            {
                if (osMacIcon == null)
                {
                    osMacIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "os_mac_icon.png", typeof(Texture2D));
                }
                return osMacIcon;
            }
        }
        ...
        public static Texture2D Refresh
        {
            get
            {
                if (refresh == null)
                {
                    refresh = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "refresh.png", typeof(Texture2D));
                }
                return refresh;
            }
        }
        ...
        public static Texture2D Trash
        {
            get
            {
                if (trash == null)
                {
                    trash = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "trash.png", typeof(Texture2D));
                }
                return trash;
            }
        }
        ...
        public static Texture2D Exclamation
        {
            get
            {
                if(exclamation == null)
                {
                    exclamation = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "exclamation.png", typeof(Texture2D));
                }
                return exclamation;
            }
        }
        ...
        public static Texture2D Info
        {
            get
            {
                if (info == null)
                {
                    info = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "info.png", typeof(Texture2D));
                }
                return info;
            }
        }
        ...
        public static Texture2D Watching
        {
            get
            {
                if(watching == null)
                {
                    watching = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "watching.png", typeof(Texture2D));
                }
                return watching;
            }
        }
        ...
        public static Texture2D NotWatching
        {
            get
            {
                if (notWatching == null)
                {
                    notWatching = (Texture2D)AssetDatabase.LoadAssetAtPath(GetAssetDirectory() + "not_watching.png", typeof(Texture2D));
                }
                return notWatching;
            }
        }
