...
public class ZoomTestWindow : EditorWindow
{
    ...
    {
        ZoomTestWindow window = GetWindow<ZoomTestWindow>(false, "Zoom Test");
        window.minSize = new Vector2(600.0f, 300.0f);
        window.wantsMouseMove = true;
        window.Show();
        FocusWindowIfItsOpen<ZoomTestWindow>();
    }
    ...
    {
        return (screenCoords - _zoomArea.position) / _zoom + _zoomCoordsOrigin;
    }
