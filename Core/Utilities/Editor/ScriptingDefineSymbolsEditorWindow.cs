...
namespace Utils.Core.ScriptingDefineSymbols
{
    /// <summary>
    /// Editor window for managing Scripting Define Symbols more easily
    /// Open in editor -> Utils/Scripting Define Symbols
    /// </summary>
    public class ScriptingDefineSymbolsEditorWindow : EditorWindow
    {
        ...
        [MenuItem("Utils/Scripting Define Symbols", false)]
